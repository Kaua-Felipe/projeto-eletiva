<?php
    ...
    if(empty($_POST["nome_aluno"]) || empty($_POST["data_nascimento"]) || empty($_POST["numero_chamada"])) {
        ...
        $inserir_aluno   = "INSERT INTO alunos (nome_aluno, dataNascimento_aluno, numero_aluno) VALUES ('$nome_aluno', '$data_nascimento', $numero_chamada)";
        ...
        if(!$executar_insercao_aluno) {
            ...
            header("location: ../templates/lista_alunos.php");
        }
    }
?>